...
export async function generateSitemapXml(request) {
  ...
  const staticPages = [
    ...
    { url: `${siteUrl}/early-access`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${siteUrl}/banarasi-sarees`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.9 },
    { url: `${siteUrl}/banarasi-suits`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.85 },
    { url: `${siteUrl}/banarasi-lehengas`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.8 },
    { url: `${siteUrl}/banarasi-dupattas`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.8 },
    { url: `${siteUrl}/banarasi-fabrics`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.8 },
