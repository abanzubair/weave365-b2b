export const translations = {
  en: {
    ...
    tab1Submit: 'Product Review',
    tab2Payment: 'Payment Terms',
    tab3Onboarding: 'Onboarding Form',
    ...
    confirmPhotosAuth: 'I confirm that all registration information provided is accurate and authentic.',
    submitReviewBtn: 'Submit Products for Review',
    uploadingCatalogs: 'Processing...',
  ...
  hi: {
    ...
    tab1Submit: 'प्रोडक्ट रिव्यू',
    tab2Payment: 'पेमेंट शर्तें',
    tab3Onboarding: 'ऑनबोर्डिंग फॉर्म',
    ...
    confirmPhotosAuth: 'मैं पुष्टि करता हूँ कि प्रदान की गई सभी रजिस्ट्रेशन जानकारी सटीक और वास्तविक है।',
    submitReviewBtn: 'रिव्यू के लिए प्रोडक्ट्स भेजें',
    uploadingCatalogs: 'प्रोसेस हो रहा है...',
