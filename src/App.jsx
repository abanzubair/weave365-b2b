...
const WeaverOnboardingPage = safeLazy(() => import('./views/WeaverOnboardingPage.jsx').then(m => ({ default: m.WeaverOnboardingPage })));
...
const AffiliateProgramPage = safeLazy(() => import('./views/AffiliateProgramPage.jsx').then(m => ({ default: m.AffiliateProgramPage })));
