...
const BulkInquiry = safeLazy(() => import('./views/BulkInquiry.jsx').then(m => ({ default: m.BulkInquiry })));
...
const NewArrivalsPage = dynamic(() => import('./views/NewArrivalsPage.jsx').then(m => ({ default: m.NewArrivalsPage })), { ssr: false });
const SeoLandingPage = dynamic(() => import('./views/SeoLandingPage.jsx').then(m => ({ default: m.SeoLandingPage })), { ssr: false });
const WeaveComparisonGuidePage = dynamic(() => import('./views/WeaveComparisonGuidePage.jsx').then(m => ({ default: m.WeaveComparisonGuidePage })), { ssr: false });
...
const BlogList = dynamic(() => import('./views/BlogList.jsx').then(m => ({ default: m.BlogList })), { ssr: false });
const BlogPost = dynamic(() => import('./views/BlogPost.jsx').then(m => ({ default: m.BlogPost })), { ssr: false });
const AboutPage = dynamic(() => import('./views/AboutPage.jsx').then(m => ({ default: m.AboutPage })), { ssr: false });
const ReviewsPage = dynamic(() => import('./views/ReviewsPage.jsx').then(m => ({ default: m.ReviewsPage })), { ssr: false });
const EarlyAccessPage = dynamic(() => import('./views/EarlyAccessPage.jsx').then(m => ({ default: m.EarlyAccessPage })), { ssr: false });
const ContactPage = dynamic(() => import('./views/ContactPage.jsx').then(m => ({ default: m.ContactPage })), { ssr: false });
