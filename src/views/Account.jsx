  ...
  return (
    <section className="account-page">
      ...
      <div className={`account-dashboard-grid tab-active-${activeTab}`}>
        ...
        {activeTab === 'developer' && (
          <article className="account-panel panel-developer" style={{ gridColumn: '1 / -1', width: '100%', maxWidth: '100%', minWidth: 0, overflowX: 'hidden', background: 'transparent', padding: 0, border: 'none', boxShadow: 'none' }}>
