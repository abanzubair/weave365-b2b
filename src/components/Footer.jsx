        ...
        <div className="footer-nav-grid">
          ...
          <div className="footer-nav-col">
            ...
            <ul className="footer-link-list">
              ...
              <li><a href={storeConfig.whatsappCommunity || storeConfig.whatsappChannel || "https://chat.whatsapp.com/J6DAhAYZDrC5JPguNLfrga"} target="_blank" rel="noreferrer">WhatsApp Community</a></li>
            </ul>
          </div>
