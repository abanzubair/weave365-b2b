...
const CSP_DIRECTIVES = [
  ...
  "frame-src 'self' https://ecom-template-1-tau.vercel.app https://50k-gamma.vercel.app",
  "frame-ancestors 'self' https://ecom-template-1-tau.vercel.app https://50k-gamma.vercel.app",
  "object-src 'none'",
  "base-uri 'self'",
  "form-action 'self'",
].join('; ');
